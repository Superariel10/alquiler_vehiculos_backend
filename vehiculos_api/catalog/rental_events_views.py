...
from .mongo_serializers import Rental_eventsSerializer
...
def rental_events_list_create(request):
    ...
    serializer = Rental_eventsSerializer(data=request.data)
...
def rental_events_detail(request, id: str):
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = Rental_eventsSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
