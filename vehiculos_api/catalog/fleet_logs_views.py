...
from .mongo_serializers import Fleet_logsSerializer
...
def fleet_logs_list_create(request):
    ...
    serializer = Fleet_logsSerializer(data=request.data)
...
def fleet_logs_detail(request, id: str):
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = Fleet_logsSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
